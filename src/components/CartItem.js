  ...
  return( 
    ...
    gap-x-4'>
      ...
      <div className='w-full flex flex-col'>
        ...
        text-sm'>
          {/** qty */}
          <div className='flex flex-1 items-center max-w-[100px] 
          items-center h-full border text-primary font-medium'>
            {/**minus icon */}
            <div onClick={() => decrementAmount(id)} className='flex-1 h-full flex justify-center items-center cursor-pointer h-full'>
            <IoMdRemove />
            </div>
